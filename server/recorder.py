...
class EpisodeRecorder:
    ...
    def record_observation(
        self, episode_id: str, obs_type: str, data: Dict[str, Any], frame_jpeg: Optional[bytes] = None
    ) -> None:
    ...
    def end_episode(self, episode_id: str, status: str, detail: Optional[str] = None) -> None:
